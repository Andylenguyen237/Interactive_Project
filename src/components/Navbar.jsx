...
//import logo from '/Users/andylenguyen/Documents/Interactive_Project/src/assets/andy-high-resolution-logo-white.svg'
    ...
    <nav className={'${styles.paddingX} w-full flex items-center py-5 fixed top-0 z-20 ${scrolled ? "bg-primary" : "bg-transparent"}'}>
      ...
      <div className='w-full flex justify-between items-center max-w-7xl mx-auto'>
        <Link 
          ...
          onClick={() => {
            setActive(""); //to know where we are on the page
            window.scrollTo(0,0) //when clicked, scroll to the top 
          }}>
